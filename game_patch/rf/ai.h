...
namespace rf
{
    ...
    static auto& ai_path_create_from_waypoints = addr_as_ref<bool(int entity_handle)>(0x0040A9B0);
    static auto& ai_path_create_to_pos = addr_as_ref<bool(int entity_handle, Vector3* end_pos)>(0x0040AC90);
